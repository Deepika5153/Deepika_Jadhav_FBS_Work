...
Total_Interior_cost = Interior_Area * Interiorcost
print(f'Cost of Paiting Interior Wall of Given diagram is {Total_Interior_cost}')

Exterior_Area = areaOfWall * 7
Total_Exterior_cost = Exterior_Area * Exteriorcost
print(f'Cost of Paiting Exterior Wall of Given diagram is {Total_Exterior_cost}')
